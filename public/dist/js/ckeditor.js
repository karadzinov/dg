...
(function () {
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], f = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, d = /"/g, h = /&amp;/g, k = /&gt;/g, j = /&lt;/g, g = /&quot;/g;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, f = function (a, e) {
                ...
                table: 1,
                ul: 1
            }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, k = {"#": 1},
    ...
    CKEDITOR.dom.element.setMarker = function (a, f, b, c) {
        var e = f.getCustomData("list_marker_id") || f.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            d = f.getCustomData("list_marker_names") || f.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[e] = f;
        d[b] = 1;
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(),
                        y = f.$.documentElement, s = y.clientTop || j.$.clientTop || 0,
                        w = y.clientLeft || j.$.clientLeft || 0, q = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function a(a, b) {
            ...
            d = c.endContainer;
            var m = c.startOffset, f = c.endOffset, h, o = this.guard, l = this.type,
                p = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var r = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    n = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(f) : d.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !r.equals(a)) && (!n ||
                        !a.equals(n)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var g = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
                    C = e.type == CKEDITOR.NODE_ELEMENT ? m ? e.getChild(m - 1) : null : e.getPrevious();
        ...
        var d = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), j = CKEDITOR.dom.walker.temp();
                ...
                clone: function () {
                    ...
                    switch (a) {
                        ...
                        case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                            ...
                            var I, v,
                                G = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                                z = null, B = function (a) {
                    ...
                    if (!this.collapsed) {
                        var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), e = this.startContainer,
                            f = this.endContainer,
                    ...
                    var b = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                        c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, e = c.block,
                        f = null;
                    ...
                    var c = new CKEDITOR.dom.range(this.root), d = 0, e,
    ...
    (function () {
        ...
        function b(a, c, d, e) {
            ...
            if ((h = CKEDITOR.filter.instances[e.element.data("cke-filter")]) &&
                !h.check(c)) return b(a, c, d, e.remaining);
    ...
    (function () {
        ...
        var L = CKEDITOR.dtd, F = 1, K = CKEDITOR.tools.copy, I = CKEDITOR.tools.trim, v = "cke-test",
            G = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, e) {
                ...
                var e = this, f = [], p = this.editor && this.editor.config.protectedSource, r, x = false,
        ...
        var z = {styles: 1, attributes: 1, classes: 1},
            B = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
            x = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            E = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, $ = /^cke:(object|embed|param)$/,
            aa = /^(object|embed|param)$/, ba = CKEDITOR.filter.transformationsTools = {
    ...
    (function () {
        CKEDITOR.lang = {
            languages: {
                ...
                var b = this.languages, f = f || navigator.userLanguage || navigator.language || a,
                    c = f.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), e = c[1], c = c[2];
    ...
    CKEDITOR.ui.prototype = {
        add: function (a, f, b) {
            ...
            var f = this.items[a], b = f && this._.handlers[f.type],
                c = f && f.command && this.editor.getCommand(f.command), b = b && b.create.apply(this, f.args);
            this.instances[a] = b;
            c && c.uiItems.push(b);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                ...
                var f = this.parent.children, b = CKEDITOR.tools.indexOf(f, this), c = a.previous = this.previous,
                    e = a.next = this.next;
                c && (c.next = a);
                e && (e.previous = a);
                f[b] = a;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (d, h, k) {
                ...
                var q = new CKEDITOR.htmlParser,
                    t = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment,
                    i = [], A = [], u = t, o = t.name == "textarea", l = t.name == "pre";
                ...
                q.onText = function (a) {
                    ...
                    var b = u.name,
                        d = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!o && !d["#"] && b in f) {
                        q.onTagOpen(e[b] || "");
                        q.onText(a)
                    } else {
        ...
        a.prototype = {
            add: function (a, c, e) {
                ...
                var e = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    d = Array.prototype.slice.call(arguments, 1), f = this.rules, k = f.length, j, g, m, y;
                for (y = 0; y < k; y++) {
                    if (e) {
                        j = c.type;
                        g = c.name
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                var a = a.data, c = a.dataValue, d, c = t(c, b), c = m(c, I), c = g(c), c = m(c, K),
                    c = c.replace(G, "$1cke:$2"), c = c.replace(B, "<cke:$1$2></cke:$1>"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        var i = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", u = CKEDITOR.dtd,
            o = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            l = CKEDITOR.tools.extend({}, u.$blockLimit, u.$block), p = {elements: {input: k, textarea: k}}, r = {
        ...
        var C = /<(a|area|img|input|source)\b([^>]*)>/gi,
            L = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i,
            K = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            I = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, v = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, f = a.elementMode,
                k = a.fire("uiSpace", {space: "top", html: ""}).html,
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, f) {
            var k = this.container, j = this.ui.space("contents"),
    ...
    (function () {
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var b = this.editor, c = b.getSelection().getStartElement().hasAscendant("pre",
                            true) ? CKEDITOR.ENTER_BR : b.activeEnterMode, b = c == CKEDITOR.ENTER_BR, d = CKEDITOR.tools,
                    ...
                    k(this);
                    var b = this.editor, d = b.activeEnterMode, b = b.getSelection(), e = b.getRanges()[0],
                        f = a.getName(), f = CKEDITOR.dtd.$block[f];
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in l) {
                                var b = a.getSelection(), f, h = b.getRanges()[0], g = h.startPath(), o, m, j,
                                    c = c == 8;
        ...
        var m = CKEDITOR.dom.walker.bogus(),
            ...
            s = CKEDITOR.dom.walker.whitespaces(true), w = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var q = function () {
            ...
            function d(b, c) {
                ...
                for (n && e.push(" "); h < l; h++) {
                    p = f.getItem(h);
                    a(p) &&
                    !p.is(g) ? e = e.concat(d(p, c)) : e.push(p)
                }
                n && e.push(" ");
                return e
            }
            ...
            return function (g, n, k) {
                ...
                if (!v.checkReadOnly()) {
                    ...
                    if (B = k) {
                        ...
                        if (/^\s+|\s+$/.test(k) && "span" in CKEDITOR.dtd[s]) var y = '<span data-cke-marker="1">&nbsp;</span>',
                            k = y + k + y;
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                ...
                var e = d.document, l = CKEDITOR.document, g = d.editable(), p = e.getBody(),
                    i = e.getDocumentElement(), v = g.isInline(), j, z;
                    ...
                    var a = A ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (var e = d.children, f, g, h = b.duplicate(), v = 0, l = e.length - 1, i = -1, j, x; v <= l;) {
                                ...
                                if (j > 0) l = i - 1; else if (j < 0) v = i + 1; else return {
                                    container: d,
                                    offset: a(f)
                                }
                            }
    ...
    (function () {
            ...
            if (b.collapsed) {
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        var r = n.type == CKEDITOR.NODE_ELEMENT ? n.getName() : null,
                            s = r && n.getAttribute("contentEditable") == "false",
                            t = r && n.getAttribute("data-nostyle");
        ...
        function s(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = o(this)[a.getName()],
        ...
        var r = {
            ...
            }, n =
                {
                    ...
                    audio: 1,
                    video: 1
                }, P = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, L = CKEDITOR.dom.walker.bookmark(0, 1),
            ...
            if (!b) {
                ...
                this.on("selectionChange", function (a) {
                    for (var e = 0; e < b.length; e++) {
                        var d = b[e],
                            f = d.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                        d.fn.call(this, f)
                    }
                })
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var f = this.$.parentNode, b = f.childNodes.length, c = this.getLength(), e = this.getDocument(),
    ...
    (function () {
        function a(a, c, e) {
            var d = a.serializable, f = c[e ? "endContainer" : "startContainer"], k = e ? "endOffset" : "startOffset",
                j = d ? c.document.getById(a.startNode) : a.startNode,
...
*/
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", i = 0; i < a.items.length; i++) {
                                var j = a.items[i], h = j[2] !== void 0 ? j[2] : j[0],
                                    l = j[1] !== void 0 ? j[1] : j[0], m = CKEDITOR.tools.getNextId() + "_radio_input",
                                    n = m + "_label",
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, n, {
                getInputElement: function () {
                    ...
                    var a = this._, d = CKEDITOR.document.getById(a.frameId).getFrameDocument(), f = a.definition,
                        c = a.buttons, e = this.formLoadedNumber, k = this.formUnloadNumber,
    ...
    (function () {
        ...
        function U(a) {
            function b(b) {
                var c = a.getSize(), i = CKEDITOR.document.getWindow().getViewPaneSize(), o = b.data.$.screenX,
                    j = b.data.$.screenY, n = o - e.x, l = j - e.y;
                e = {x: o, y: j};
                d.x += n;
                d.y += l;
            ...
            var e = null, d = null, g = a.getParentEditor(), f = g.config.dialog_magnetDistance,
        ...
        function V(a) {
            ...
            function e(d) {
                var e = "rtl" == h.lang.dir, j = o.width, C = o.height,
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, e, d, g,
                                     f) {
                    if (!(4 > arguments.length)) {
                        var h = (e.call ? e(b) : e) || "div", m = ["<", h, " "], k = (d && d.call ? d(b) : d) || {},
                            i = (g && g.call ? g(b) : g) || {}, o = (f && f.call ? f.call(this, a, b) : f) || "",
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var g = this._.children = b, f = d && d.widths || null, h = d && d.height || null, m,
                            k = {role: "presentation"};
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = j.element.getWindow(), a = d.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                                ...
                                i = m ? a.right : b.width - a.left, g = m ? b.width - a.right : a.left;
    ...
    CKEDITOR.plugins.add("resize", {
        init: function (b) {
            ...
            function c(d) {
                var e = f, l = g, c = e + (d.data.$.screenX - n) * ("rtl" == h ? -1 : 1),
    ...
    (function () {
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (b,
                                  d, a, h) {
                if (a = a || r(b)) {
                    var a = u(a), f = a.document, i = a.checkStartOfBlock(), k = a.checkEndOfBlock(),
                        j = b.elementPath(a.startContainer), c = j.block, l = d == CKEDITOR.ENTER_DIV ? "div" : "p", e;
                    if (i && k) {
                        if (c && (c.is("li") || c.getParent().is("li"))) {
                            c.is("li") || (c = c.getParent());
                            a = c.getParent();
                            e = a.getParent();
                            var h = !c.hasPrevious(), n = !c.hasNext(), l = b.getSelection(), g = l.createBookmarks(),
                                i = c.getDirection(1), k = c.getAttribute("class"), o = c.getAttribute("style"),
                                m = e.getDirection(1) != i, b = b.enterMode != CKEDITOR.ENTER_BR || m || o || k;
                ...
                if (a = a || r(b)) {
                    var f = a.document, i = a.checkEndOfBlock(),
                        k = new CKEDITOR.dom.elementPath(b.getSelection().getStartElement()), j = k.block,
                        c = j && k.block.getName();
    ...
    (function () {
        function i(b, f) {
            var g = {}, c = [], e = {nbsp: " ", shy: "­", gt: ">", lt: "<", amp: "&", apos: "'", quot: '"'},
    ...
    (function () {
        function i(a) {
            var j = a.config, m = a.fire("uiSpace", {space: "top", html: ""}).html, p = function () {
                ...
                var k, i, l, c, h, n, r, m = j.floatSpaceDockedOffsetX || 0, o = j.floatSpaceDockedOffsetY || 0,
                    q = j.floatSpacePinnedOffsetX || 0, t = j.floatSpacePinnedOffsetY ||
                        0;
                return function (d) {
            ...
            $: function () {
                ...
                setData: function (a, e) {
                    ...
                    if (e) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady"); else {
                        ...
                        b._.dataStore = {id: 1};
                        var c = b.config, d = c.fullPage, g = c.docType,
                    ...
                    var a = this.editor, e = a.config, b = e.fullPage, c = b && a.docType, d = b && a.xmlDeclaration,
    ...
    (function () {
        ...
        var p = /^javascript:/, q = /^mailto:([^?]+)(?:\?(.+))?$/, r = /subject=([^;?:@&=$,\/]*)/,
            s = /body=([^;?:@&=$,\/]*)/, t = /^#(.*)$/, u = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c) {
                ...
                var a = b && (b.data("cke-saved-href") ||
                        b.getAttribute("href")) || "", f = c.plugins.link.compiledProtectionFunction,
                ...
                switch (b.type) {
                    ...
                    case "email":
                        ...
                        switch (a) {
                            case "":
                            case "encode":
                                var g = encodeURIComponent(d.subject || ""), i = encodeURIComponent(d.body || ""),
                                    d = [];
                                g && d.push("subject=" + g);
                                i && d.push("body=" + i);
                                d = d.length ? "?" + d.join("&") : "";
    ...
    (function () {
        function E(b, k, e) {
            ...
            var c = CKEDITOR.plugins.list.arrayToList(f, e, null, b.config.enterMode, k.root.getAttribute("dir")).listNode,
                a, m;
            d(!0);
            d();
            c.replace(k.root);
        ...
        function y(b, k, e) {
            ...
            k.trim(!1, !0);
            var f = k.createBookmark(), g = new CKEDITOR.dom.elementPath(k.startContainer), i = g.block,
                g = g.lastElement.getAscendant("li", 1) || i, h = new CKEDITOR.dom.elementPath(e.startContainer),
                c = h.contains(CKEDITOR.dtd.$listItem), h = h.contains(CKEDITOR.dtd.$list);
            ...
            listToArray: function (b,
                ...
                for (var g, i = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(i), c = null, a = e, m = Math.max(b[e].indent, 0), j = null, n, l, p = d == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (o.indent == m) {
                        ...
                        var c = g.getDirection(1) != n, u = o.element, z = u.getAttribute("class"),
                            v = u.getAttribute("style"),
                            w = j.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || c || v || z), s,
    ...
    (function () {
        ...
        function ha(a) {
            ...
            q(d, {
                ...
                place: function () {
                    var b = a.view, c = a.editable, d = a.trigger, i = d.upper, h = d.lower, j = i || h,
                        l = j.getParent(), k = {};
                    this.trigger = d;
                    i && o(a, i, !0);
                    h && o(a, h, !0);
        ...
        var q = CKEDITOR.tools.extend, M = CKEDITOR.dom.element, B = M.createFromHtml, n = CKEDITOR.env,
            ea = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, w = CKEDITOR.dtd, F = {}, D = 128, Z = 64, O = 32, H = 16,
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ?
                        [a.config.scayt_disableOptionsStorage] : void 0,
            ...
            var c = a.dataProcessor, d = c && c.htmlFilter, b = a._.elementsPath && a._.elementsPath.filters,
                c = c && c.dataFilter, e = a.addRemoveFormatFilter, g = function (d) {
        ...
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    if (!CKEDITOR.plugins.scayt || !CKEDITOR.plugins.scayt.state[this.name] || !this.scayt) b = a.call(this); else if (b = "ready" == this.status) var g = c.removeMarkupFromString(this.getSnapshot()),
                        c = c.removeMarkupFromString(this._.previousValue), b = b && c !== g;
                    return b
                }
            });
