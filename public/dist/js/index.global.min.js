...
var FullCalendar = function(e) {
    ...
    function A(e, t, n, r, i, s, o, a, d, u) {
        ...
        for (n.__k = [], h = 0; h < t.length; h++)
            if (null != (v = n.__k[h] = null == (v = t[h]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? g(null, v, null, null, v) : Array.isArray(v) ? g(m, {
                ...
                if (v.__ = n, v.__b = n.__b + 1, null === (p = A[h]) || p && v.key == p.key && v.type === p.type)
                    A[h] = void 0;
                else
                    for (f = 0; f < w; f++) {
                ...
                k(e, v, p = p || l, i, s, o, a, d, u),
                    b = v.__e,
                (f = v.ref) && p.ref != f && (S || (S = []), p.ref && S.push(p.ref, null, v), S.push(f, v.__c || b, v)),
                    null != b ? (null == E && (E = b), "function" == typeof v.type && v.__k === p.__k ? v.__d = d = D(v, d, e) : d = C(e, v, p, A, b, d), "function" == typeof n.type && (n.__d = d)) : d && p.__e == d && d.parentNode != e && (d = y(p))
            }
        for (n.__e = E, h = w; h--;)
            null != A[h] && N(A[h], A[h]);
        if (S)
    ...
    function D(e, t, n) {
        for (var r, i = e.__k, s = 0; i && s < i.length; s++)
            (r = i[s]) && (r.__ = e, t = "function" == typeof r.type ? D(r, t, n) : C(n, r, r, i, r.__e, t));
        return t
    }
    function w(e, t) {
    ...
    function k(e, t, r, i, s, o, a, l, c) {
        ...
        if (void 0 !== t.constructor)
            return null;
        null != r.__h && (c = r.__h, l = t.__e = r.__e, t.__h = null, o = [l]),
        (d = n.__b) && d(t);
        try {
            e:
                if ("function" == typeof T) {
                    if (E = t.props, S = (d = T.contextType) && i[d.__c], D = d ? S ? S.props.value : d.__ : i, r.__c ? b = (h = t.__c = r.__c).__ = h.__E : ("prototype" in T && T.prototype.render ? t.__c = h = new T(E, D) : (t.__c = h = new v(E, D), h.constructor = T, h.render = P), S && S.sub(h), h.props = E, h.state || (h.state = {}), h.context = D, h.__n = i, f = h.__d = !0, h.__h = [], h._sb = []), null == h.__s && (h.__s = h.state), null != T.getDerivedStateFromProps && (h.__s == h.state && (h.__s = u({}, h.__s)), u(h.__s, T.getDerivedStateFromProps(E, h.__s))), g = h.props, p = h.state, f)
                    ...
                    null == o && t.__v === r.__v ? (t.__k = r.__k, t.__e = r.__e) : t.__e = I(r.__e, t, r, i, s, o, a, c);
            (d = n.diffed) && d(t)
        } catch (e) {
            t.__v = null,
            (c || null != o) && (t.__e = l, t.__h = !!c, o[o.indexOf(l)] = null),
                n.__e(e, t, r)
        }
    }
    function M(e, t) {
    ...
    function I(e, n, r, i, s, o, a, c) {
        ...
        if (null === m)
            ...
            if (function(e, t, n, r, i) {
                ...
                for (s in t)
                    i && "function" != typeof t[s] || "children" === s || "key" === s || "value" === s || "checked" === s || n[s] === t[s] || x(e, s, t[s], n[s], r)
            }(e, p, g, s, c), f)
                n.__k = [];
    ...
    function X(e) {
        var t = B,
            n = e.__c;
        "function" == typeof n && (e.__c = void 0, n()),
            B = t
    }
    function $(e) {
        var t = B;
    ...
    n.vnode = function(e) {
        ...
        if ("string" == typeof t) {
            ...
            "select" == t && null != r.defaultValue && (r.value = w(n.children).forEach((function(e) {
                ...
                e.props = r,
            n.class != n.className && (ye.enumerable = "className" in n, null != n.className && (r.class = n.className), Object.defineProperty(r, "className", ye))
        }
        e.$$typeof = de,
        be && be(e)
    };
    ...
    class Zt {
        constructor(e)
        {
            let t = {},
                ...
                r = 0;
            for (let i in e)
                i in Lt ? (n[i] = e[i], r = Math.max(Lt[i], r)) : (t[i] = e[i], i in Ft && (r = Math.max(Ft[i], r)));
    ...
    class rs {
        ...
        insertEntryAt(e, t)
        {
            ...
            -1 === t.lateral ? (ls(r, t.level, t.levelCoord), ls(n, t.level, [e])) : ls(n[t.level], t.lateral, e),
    ...
    class ws {
        constructor(e, t)
        {
            let n = e.start,
                ...
                o = -1;
            for (; n < r;)
                t.isHiddenDay(n) ? i.push(o + .5) : (o += 1, i.push(o), s.push(n)),
                    n = bt(n, 1);
            this.dates = s,
                this.indices = i,
                this.cnt = s.length
    ...
    var So = {
            ...
            }
            {
                ...
                handle(e)
                {
                    const {map: t} = this;
                    let n = !1;
                    e.isActive ? (t.set(e.id, e), n = !0) : t.has(e.id) && (t.delete(e.id), n = !0),
                    n && this.set(t)
                }
            }
            ,
        ...
        recurringTypes: [{
            ...
            expand(e, t, n) {
                ...
                return r ? function(e, t, n, r) {
                    ...
                    for (; s < o;) {
                        let e;
                        i && !i[s.getUTCDay()] || (e = t ? r.add(s, t) : s, a.push(e)),
                            s = bt(s, 1)
                    }
                    return a
    ...
    class sa {
            ...
            this.data && this.data.dateProfileGenerator !== a.dateProfileGenerator && (d = a.dateProfileGenerator.build(c)),
                ...
                d = function(e, t, n, r) {
                    ...
                    switch (t.type) {
                        ...
                        case "PREV":
                            if (i = r.buildPrev(e, n), i.isValid)
                                return i;
                            break;
                        case "NEXT":
                            if (i = r.buildNext(e, n), i.isValid)
                                return i
                    }
                    return e
        ...
        processRawCalendarOptions(e, t)
        {
            let {locales: n, locale: r} = un([rn, e, t]),
                ...
                g = !1;
            for (let e in d)
                -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || an[e] && e in h && an[e](h[e], d[e])) ? u[e] = f[e] : l[e] ? (u[e] = l[e](d[e]), g = !0) : c[e] = h[e];
        ...
        processRawViewOptions(e, t, n, r, i)
        {
            let s = un([rn, e.optionDefaults, n, r, e.optionOverrides, i]),
                ...
                u = {};
            for (let e in s)
                s[e] === l[e] || an[e] && an[e](s[e], l[e]) ? a[e] = c[e] : (s[e] === this.currentCalendarOptionsInput[e] || an[e] && an[e](s[e], this.currentCalendarOptionsInput[e]) ? e in this.currentCalendarOptionsRefined && (a[e] = this.currentCalendarOptionsRefined[e]) : o[e] ? a[e] = o[e](s[e]) : u[e] = s[e], d = !0);
    ...
    class Ma extends Ki {
        ...
        setScrollTop(e)
        {
            ...
            this.doesListening || (this.scrollTop = Math.max(Math.min(e, this.getMaxScrollTop()), 0), this.handleScrollChange())
        }
        setScrollLeft(e)
        {
            this.scrollController.setScrollLeft(e),
            this.doesListening || (this.scrollLeft = Math.max(Math.min(e, this.getMaxScrollLeft()), 0), this.handleScrollChange())
        }
        getClientWidth()
        {
    ...
    class Pa {
        ...
        handleMove(e, t)
        {
            if (this.isEnabled) {
                ...
                this.isAnimating || (this.isAnimating = !0, this.requestAnimation(Na()))
            }
        }
        stop()
        {
            ...
            super(e),
                ...
                this.handleHitUpdate = (e, t) => {
                    ...
                    this.displayDrag(s, c),
                        l ? Ge() : Qe(),
                    t || (i === s && Ua(r, e) && (o = null), this.dragging.setMirrorNeedsRevert(!o), this.dragging.setMirrorIsVisible(!e || !this.subjectEl.getRootNode().querySelector(".fc-event-mirror")), this.receivingContext = s, this.validMutation = o, this.mutatedRelevantEvents = a)
                },
                ...
                constructor(e)
                {
                    super(e),
                        ...
                        this.handleHitUpdate = (e, t, n) => {
                            ...
                            a && (l = Gr(i, r.getCurrentData().eventUiBases, a, r), d.mutatedEvents = l, _s(d, e.dateProfile, r) || (c = !0, a = null, l = null, d.mutatedEvents = null)),
                                l ? r.dispatch({
                                ...
                                c ? Ge() : Qe(),
                            t || (a && Ua(s, e) && (a = null), this.validMutation = a, this.mutatedRelevantEvents = l)
                        },
                        this.handleDragEnd = e => {
                            let {context: t} = this.component,
    ...
    function al(e, t, n, r, i, s, o) {
        ...
        a.allowReslicing = !0,
            a.strictOrder = r,
            !0 === t || !0 === n ? (a.maxCoord = s, a.hiddenConsumes = !0) : "number" == typeof t ? a.maxStackCnt = t : "number" == typeof n && (a.maxStackCnt = n, a.hiddenConsumes = !0);
        let l = [],
            c = [];
            ...
            super(),
                ...
                this.handleRenderRequest = () => {
                    if (this.isRendering) {
                        ...
                        this.isRendered && (this.isRendered = !1, H(null, this.el), this.setClassNames([]), this.setHeight(""))
                },
                function(e) {
