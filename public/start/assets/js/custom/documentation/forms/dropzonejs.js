    ...
    new Dropzone("#kt_dropzonejs_example_1", {
      ...
      (function () {
        ...
        l.on("addedfile", function (r) {
          (r.previewElement.querySelector(e + " .dropzone-start").onclick =
            function () {
              l.enqueueFile(r);
            }),
          ...
          o
            ...
            .addEventListener("click", function () {
              l.enqueueFiles(l.getFilesWithStatus(Dropzone.ADDED));
            }),
          o
            .querySelector(".dropzone-remove-all")
            .addEventListener("click", function () {
              (o.querySelector(".dropzone-upload").style.display = "none"),
                (o.querySelector(".dropzone-remove-all").style.display =
                  "none"),
                l.removeAllFiles(!0);
            }),
          ...
          l.on("removedfile", function (e) {
            l.files.length < 1 &&
              ((o.querySelector(".dropzone-upload").style.display = "none"),
              (o.querySelector(".dropzone-remove-all").style.display = "none"));
          });
      })(),
      (function () {
