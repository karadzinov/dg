...
<div class="page-wrapper">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="header-left clearfix">
                            ...
                            <div id="logo" class="logo">
                                <h2 class="text-center logo-font margin-clear"><a href="#" class="text-muted">Boban<span class="text-default"><i class="pl-10 pr-10 fa fa-heart"></i></span>Elena</a></h2>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="text-center logo-font text-muted">Boban &amp; <span class="text-default">Elena</span></h2>
                    <div class="separator"></div>
    ...
    <section class="full-width-section">
        <div class="full-text-container left light-gray-bg border-clear text-right">
            ...
            <p>На секој човек му е потребен животен сопатник, многу љубов и разбирање.  <br />Ако сонцето ја има месечината, денот ја има ноќта, планината го има морето, животот ја има смртта, длабочината ја има висината, галамата ја има тишината, среќата ја има тагата, доброто го има злото - јас ја имам Тилиа. Таа е сè што недостасуваше во мојот живот, а заедно сме енергијата, земјата, водата, воздухот и огнот. Ви благодарам што сте дел од нашиот живот. <br /> Дојдете да си поминеме убаво!</p>
        ...
        <div class="full-image-container light-gray-bg border-clear">
            ...
            <div class="full-image-overlay text-center">
                ...
                <ul class="social-links circle animated-effect-1 text-center">
                    <li class="facebook"><a target="_blank" href="https://www.facebook.com/karadzinov"><i class="fa fa-facebook"></i></a></li>
                    <li class="twitter"><a target="_blank" href="https://twitter.com/tiggaz"><i class="fa fa-twitter"></i></a></li>
                    <li class="instagram"><a target="_blank" href="https://www.instagram.com/martin.karadzinov/"><i class="fa fa-instagram"></i></a></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="full-width-section">
        <div class="full-image-container default-bg">
            ...
            <div class="full-image-overlay text-center">
                ...
                <ul class="social-links circle animated-effect-1 text-center">
                    <li class="facebook"><a target="_blank" href="https://www.facebook.com/tilia.ivanovska"><i class="fa fa-facebook"></i></a></li>
                    <li class="twitter"><a target="_blank" href="https://twitter.com/tiliaiv/"><i class="fa fa-twitter"></i></a></li>
                    <li class="instagram"><a target="_blank" href="https://www.instagram.com/tiliaiv/"><i class="fa fa-instagram"></i></a></li>
                </ul>
            </div>
        </div>
        <div class="full-text-container default-bg">
            ...
            <div class="separator-2 visible-lg"></div>
            <p> Како секоја принцеза, така и јас сонував за принцот на бел коњ. Но, за кратко време сфатив дека реалноста е
            многу поубава од секоја бајка, од секој коњ, од секој сон... Наместо да се плашам од иднината, решив после
            една година да влезам во една друга реалност која ме научи на мир, среќа и на решителност. Заедно со Мартин
                постигнавме многу за кратко време и едвај чекам да видам што можеме да направиме понатаму. Но, без Вашата
    ...
    <section class="pv-30 clearfix">
        ...
        <div class="container">
            ...
            <h3 class="text-default text-center space-top logo-font"><span class="text-muted">Restaurant</span> Alikas</h3>
            <div class="separator"></div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11853.501157668741!2d21.4050789!3d42.0351322!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x135414c018653265%3A0x1fb5002215f81f9b!2sAllikas!5e0!3m2!1sen!2smk!4v1684963367605!5m2!1sen!2smk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="subfooter">
            <div class="container">
                <div class="subfooter-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="text-center">Copyright © 2023 by <a target="_blank" href="https://pingdevs.com">PingDevs</a>. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
