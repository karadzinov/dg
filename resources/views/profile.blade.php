                ...
                <div class="row align-items-center">
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted " href="./index.html">Ресторани</a></li>
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                            ...
                            <div class="card-body border-bottom">
                                <div class="col-12">
                                    <p>
                                        ...
                                        За да овозможиме вашата бајка да биде прераскажувана ја создадовме приказната која се вика Аllikas (извор).  Затоа што од тука сѐ започнува, затоа што од тука извира вашата љубов, слога… вашата среќа. Затоа што овде го одигра првиот танц со својата сродна душа и зачекори по патеката која се вика брак. Затоа ние сме тука, твојот ден да го направиме бајка и со насмевка да те испратиме на твоето брачно патување…
                                    </p>
                                    <p><b>ЗА НАС</b><br />
                                        Алликас е ресторан кој се наоѓа на 5 километри од центарот на градот во пријатна и тивка околина. Се протега на голема зелена површина, каде ресторанскиот дел изнесува 600 м2 и е со капацитет од 250 до 400 гости. На зеленилото е превидено да се прават свадби и прослави под отворено небо, а исто така е организирано одржување на матично на отворено. Ресторанот обезбедува паркинг-места  за 100 возила, кој ќе биде под постојан видео-надзор, како и игротека за најмалите гости. Салата за свечености е предвидена за летни и зимски свадби, што значи дека во лето се отвора од сите три страни и има подно ладење, а во зима се затвора од сите три страни со стаклена фасада и има подно греење.</p>
                                    <p><b>ТИМ</b><br />
                                        Нашиот тим од професионалци воден од проф. Небојша Вуковиќ создаде менија коишто содржат уникатни јадења, создадени за потребите на нашиот ресторан, а кои ќе ви овозможат незаборавно гастрономско уживање.
                                        ДЕМИЈЕН ДРОЦА
                                        General manager
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="col-12">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1010.5795608741408!2d21.405086081458712!3d42.03404815092993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1fb5002215f81f9b!2sAllikas!5e0!3m2!1sen!2s!4v1507806316557" width="100%" height="350px" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab" tabindex="0">
                <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-4">
                    <h3 class="mb-3 mb-sm-0 fw-semibold d-flex align-items-center">Галерија <span class="badge text-bg-secondary fs-2 rounded-4 py-1 px-2 ms-2">12</span></h3>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card hover-img overflow-hidden rounded-2">
                            <div class="card-body p-0">
                                <img src="/dist/images/alikas.jpg" alt="" class="img-fluid w-100 object-fit-cover" style="height: 220px;">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card hover-img overflow-hidden rounded-2">
                            <div class="card-body p-0">
                                <img src="/dist/images/gallery/gallery1.jpg" alt="" class="img-fluid w-100 object-fit-cover" style="height: 220px;">
                                <div class="p-4 d-flex align-items-center justify-content-between">
                                    <div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card hover-img overflow-hidden rounded-2">
                            <div class="card-body p-0">
                                <img src="/dist/images/gallery/gallery2.jpg" alt="" class="img-fluid w-100 object-fit-cover" style="height: 220px;">
                                <div class="p-4 d-flex align-items-center justify-content-between">
                                    <div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card hover-img overflow-hidden rounded-2">
                            <div class="card-body p-0">
                                <img src="/dist/images/gallery/gallery3.jpg" alt="" class="img-fluid w-100 object-fit-cover" style="height: 220px;">
                                <div class="p-4 d-flex align-items-center justify-content-between">
                                    <div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card hover-img overflow-hidden rounded-2">
                            <div class="card-body p-0">
                                <img src="/dist/images/gallery/gallery4.jpg" alt="" class="img-fluid w-100 object-fit-cover" style="height: 220px;">
                                <div class="p-4 d-flex align-items-center justify-content-between">
                                    <div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card hover-img overflow-hidden rounded-2">
                            <div class="card-body p-0">
                                <img src="/dist/images/gallery/gallery5.jpg" alt="" class="img-fluid w-100 object-fit-cover" style="height: 220px;">
                                <div class="p-4 d-flex align-items-center justify-content-between">
                                    <div>
