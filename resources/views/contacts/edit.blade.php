                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" hidden
                                               class="form-control" name="restaurant_id" value="{{ $contact->restaurant_id }}"/>
                                        @error('contactName')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control @error('desc') is-invalid @enderror" rows="10" placeholder="Text Here..."
                                                      name="desc" id="desc" >{{ $contact->desc }}</textarea>
                                            @error('desc')
                                            <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
