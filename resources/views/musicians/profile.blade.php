    ...
    <div class="container-fluid">
                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a class="text-muted"
                                                               href="{{ route('frontend.musicians') }}">Музичари/Бендови</a>
                                </li>
                                <li class="breadcrumb-item" aria-current="page">{{ $musician->name }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="card overflow-hidden">
            <div class="card-body p-0">
                <img src="/images/cover_images/musicians/originals/{{ $musician->coverImg }}" alt=""
                     class="img-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-4 order-lg-1 order-2">
                        <div class="d-flex align-items-center justify-content-around m-4">
                            <div class="text-center">
                                ...
                                <h4 class="mb-0 fw-semibold lh-1">{{ $musician->phone }}</h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-2">
                                <div
                                    ...
                                    <div
                                        ...
                                        <img src="/images/logos/musicians/thumbnails/{{ $musician->logo }}" alt=""
                                             class="w-100 h-100">
                                    </div>
                                </div>
                            </div>
