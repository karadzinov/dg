        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">{{ $musician->name }}</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a class="text-muted"
                                                               href="{{ route('musicians.profile', $musician->slug) }}">
                                        {{ $musician->name }}</a></li>
            ...
            <div class="card card-body">
                <div class="row">
                    ...
                    <div
                        ...
                        <a href="{{ route('musicians.gallery.create', $musician->id) }}"
                    ...
                    <div
                        class="col-md-3 col-xl-3 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                        <a href="{{ route('musicians.gallery.video.create', $musician->id) }}"
                           class="btn btn-info d-flex align-items-center">
                            ...
                            <tr class="search-items">
                                ...
                                <td class="text-center">
                                    <span class="usr-location"
                                          data-location="Boston, USA">{{ $album->musician->name }}</span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="action-btn">
                                        <a href="{{ route('musicians.gallery.destroy', $album->id) }}"
                                  ...
                                  document.getElementById('delete-form').submit();">
                                        ...
                                        <form id="delete-form" method="post"
                                              action="{{ route('musicians.gallery.destroy', $album->id) }}">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                    </div>
