    ...
    <div class="main-container">
        ...
        <div class="row party">
            <div class="col-12 text-center">
                ...
                <h1 class="title-gradient">Вашата е Свадбената Визија, а сè Останато е наша Мисија</h1>
                <p class="sub-title-gradient">Нашата посветеност ќе ја трансформира вашата свадба во реалност. Секој детал од вашето венчавање го планираме внимателно, од изборот на совршената локација, кетеринг, омилениот бенд за вашето венчавање, до фотографот и буквално сè друго што може да си го посакате. Кликнете подолу заедно да создадеме вистински магичен момент за вашето свадбено патување.</p>
        ...
        <div class="row party">
            <div class="col-12 text-center">
                ...
                <p class="sub-title-gradient">
                    Преточете ја Вашата радост во креативност. Кликни на еден од темплејтите подолу, одбери датум и место напишете ја Вашата љубовна приказна и додате ги најубавите слики од Вас во уникатна дигитална покана. Споделете го уникатниот линк со сите кои би сакале да бидат Ваши гости. На истата покана ќе можете да видите кој го потврдил присуството, кој каква храна преферира а по свадбата гостите на истиот линк ќе имаат пристап од сликите и видеата од Вашата свадба.
                </p>
            </div>
