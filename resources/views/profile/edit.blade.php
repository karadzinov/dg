                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('profile.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               id="subtitle"
                                               name="subtitle" value="{{ $profile->subtitle }}">
                                        @error('subtitle')
                                        <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="ckeditor @error('description') is-invalid @enderror"
                                                  ...
                                                  name="description" id="description">{{ $profile->description }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-horizontal required" id="city" name="city">
                                            @foreach($cities as $city)
                                                <option value="{{ $city->id }}" @if($city->id === $profile->city_id) selected @endif>{{ $city->admin_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                @foreach($contacts as $contact)
                                    ...
                                    <section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="desc"> Повеќе инфомации за контактот : <span class="danger">*</span>
                                                    </label>
                                                    <textarea type="text" class="form-control form-horizontal " rows="10" name="desc[]" id="desc">{{ $contact->desc }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                        ...
                        <section>
                            ...
                            <input type="hidden" id="lat" class="form-control" name="lat" value="{{ $profile->lat }}">
                            <input type="hidden" id="lng" class="form-control" name="lng" value="{{ $profile->lng }}">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               class="form-control form-horizontal"
                                               id="weblink"
                                               name="weblink" value="{{ $profile->weblink }}"/>
                                    </div>
                                </div>
                            </div>
                        </section>
...
// Google Maps
                ...
                $("#category_id").val("{{ $profile->categories()->first()->id }}").change();
