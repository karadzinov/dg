        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card card-body">
                <div class="row">
                    ...
                    <div
                        class="col-md-4 col-xl-3 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                        <a href="{{ route('photographers.create') }}" class="btn btn-info d-flex align-items-center">
                            ...
                            <tr class="search-items">
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3 align-items-middle">
                                            <div class="user-meta">
                                                <a href="{{ route('musicians.profile', $musician->slug) }}" class="title mb-0">{{ $musician->name }}</a>
                                ...
                                <td>
                                    <div class="text-center align-items-center">
                                        <div class="action-btn">
                                            <a href="{{ route('contacts.index', $musician->slug) }}" class="text-info edit">
                                                <i class="ti ti-user fs-5"></i>Види контакти
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <table class="table search-table align-middle text-nowrap">
                            ...
                            @foreach($photographers as $photographer)
                                <tr class="search-items">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/images/logos/photographers/thumbnails/{{ $photographer->logo }}"
                                                 alt="avatar" class="rounded-circle"
                                                 width="40"/>
                                            <div class="ms-3 align-items-middle">
                                                <div class="user-meta">
                                                    <a href="{{ route('photographers.profile', $photographer->slug) }}" class="title mb-0">{{ $photographer->name }}</a>
                                    ...
                                    <td>
                                        <div class="text-center align-items-center">
                                            <div class="action-btn">
                                                <a href="{{ route('contacts.index', $photographer->slug) }}" class="text-info edit">
                                                    <i class="ti ti-user fs-5"></i>Види контакти
                                                </a>
                                            </div>
                                        </div>
