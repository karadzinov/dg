...
@section('metadata')
    <title>Контакт - Драги Гости</title>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header bg-primary">
                <h4 class="mb-0 text-white">Контактирајте не (Бобан -  <i class="ti ti-phone fs-4"></i> 075 260 169)  (Филип - <i class="ti ti-phone fs-4"></i>076 454 318)  (Мартин - <i class="ti ti-phone fs-4"></i>071 213 980)</h4>
            </div>
