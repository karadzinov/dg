                    ...
                    <form action="{{ route('photographers.update', $photographer->id) }}" method="POST"
                        ...
                        <section>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name"> Име на фотограф/студио : <span class="danger">*</span>
                                        </label>
                                        <input type="text"
                                               class="form-control @error('name') is-invalid @enderror form-horizontal required"
                                               id="name"
                                               name="name" value="{{ $photographer->name }}"/>
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               id="subtitle"
                                               name="subtitle" value="{{ $photographer->subtitle }}"/>
                                        @error('subtitle')
                                        <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               id="phone"
                                               name="phone" value="{{ $photographer->phone }}"/>
                                        @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email"
                                               ...
                                               id="email"
                                               name="email" value="{{ $photographer->email }}"/>
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                        ...
                        <section>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="logo"> Лого на фотографот/студиото : <span class="danger">*</span>
                                        </label>
                                        <input type="file"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               id="facebook"
                                               name="facebook" value="{{ $photographer->facebook }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               class="form-control form-horizontal"
                                               id="instagram"
                                               name="instagram" value="{{ $photographer->instagram }}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               class="form-control form-horizontal"
                                               id="twitter"
                                               name="twitter" value="{{ $photographer->twitter }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               class="form-control form-horizontal"
                                               id="youtube"
                                               name="youtube" value="{{ $photographer->youtube }}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               class="form-control form-horizontal"
                                               id="weblink"
                                               name="weblink" value="{{ $photographer->weblink }}"/>
                                    </div>
                                </div>
                            </div>
                        </section>
