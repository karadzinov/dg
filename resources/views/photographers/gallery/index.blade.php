                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a class="text-muted"
                                                               href="{{ route('photographers.profile', $photographer->slug) }}">
            ...
            <div class="card card-body">
                <div class="row">
                    ...
                    <div
                        ...
                        <a href="{{ route('photographers.gallery.create', $photographer->id) }}"
                    ...
                    <div
                        class="col-md-3 col-xl-3 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                        <a href="{{ route('photographers.gallery.video.create', $photographer->id) }}"
                           class="btn btn-info d-flex align-items-center">
                            ...
                            <tr class="search-items">
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        <img
                                            src="/images/cover_images/photographers/thumbnails/{{ $album->coverImg }}"
                                ...
                                <td class="text-center">
                                    <span class="usr-location"
                                          data-location="Boston, USA">{{ $album->photographer->name }}</span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="action-btn">
                                        <a href="{{ route('photographers.gallery.destroy', $album->id) }}"
                                  ...
                                  document.getElementById('delete-form').submit();">
                                        ...
                                        <form id="delete-form" method="post"
                                              action="{{ route('photographers.gallery.destroy', $album->id) }}">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                    </div>
