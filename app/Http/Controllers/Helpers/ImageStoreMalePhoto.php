...
class ImageStoreMalePhoto
{
    ...
    {
        if ($this->request->hasFile('male_photo')) {
            $image = $this->request->file('male_photo');
    ...
    {
        $original = public_path() . '/images/male_photos/' . $this->path . '/originals/';;
        $thumbnail = public_path() . '/images/male_photos/' . $this->path . '/thumbnails/';
        $medium = public_path() . '/images/male_photos/' . $this->path . '/medium/';
