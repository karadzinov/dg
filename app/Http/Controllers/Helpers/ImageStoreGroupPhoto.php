...
class ImageStoreGroupPhoto
{
    ...
    {
        if ($this->request->hasFile('group_photo')) {
            $image = $this->request->file('group_photo');
    ...
    {
        $original = public_path() . '/images/group_photos/' . $this->path . '/originals/';;
        $thumbnail = public_path() . '/images/group_photos/' . $this->path . '/thumbnails/';
        $medium = public_path() . '/images/group_photos/' . $this->path . '/medium/';
