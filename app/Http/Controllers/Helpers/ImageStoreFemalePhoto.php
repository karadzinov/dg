...
class ImageStoreFemalePhoto
{
    ...
    {
        if ($this->request->hasFile('female_photo')) {
            $image = $this->request->file('female_photo');
    ...
    {
        $original = public_path() . '/images/female_photos/' . $this->path . '/originals/';;
        $thumbnail = public_path() . '/images/female_photos/' . $this->path . '/thumbnails/';
        $medium = public_path() . '/images/female_photos/' . $this->path . '/medium/';
