...
class ImageStoreCover
{
    ...
    {
        $original = public_path() . '/images/cover_images/' . $this->path . '/originals/';;
        $thumbnail = public_path() . '/images/cover_images/' . $this->path . '/thumbnails/';
        $medium = public_path() . '/images/cover_images/' . $this->path . '/medium/';
